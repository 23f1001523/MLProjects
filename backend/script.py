...
def main():
    ...
    print("Running IPL model training scripts...")
    ...
    print("Running Churn model Training scripts...")
    subprocess.run(["python", "churn_customers/training_scripts/train_churn_model.py"], check=True)
